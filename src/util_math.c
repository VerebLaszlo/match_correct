...
const TIME_CONVERSION_CONSTANTS TIME_CONVERSION_CONSTANT = { 60.0, 1.0 / 60.0, 60.0, 1.0 / 60.0,
		60.0 * 60.0, 1.0 / (60.0 * 60.0), 24.0, 1.0 / 24.0, 24.0 * 60.0, 1.0 / (24.0 * 60.0), 24.0
				* 60.0 * 60.0, 1.0 / (24.0 * 60.0 * 60.0), };

const CONVERSION_CONSTANTS CONVERSION_CONSTANT = { 180.0 / M_PI, M_PI / 180.0, 15.0 * M_PI / 180.0,
		1.0 / (15.0 * M_PI / 180.0), 15.0, 1.0 / 15.0, 15.0 * M_PI / 180.0 / 60.0, 1.0
				/ (15.0 * M_PI / 180.0 / 60.0), 15.0 * M_PI / 180.0 / 60.0 / 60.0, 1.0
